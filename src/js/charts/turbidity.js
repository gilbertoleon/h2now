var Turbidity = function (wrapper, i, branches, domain) {
  var debug = false;
  ...
  var fullText =
    "Turbidity is a measurement of the clarity of water, and is an important component of our real-time water quality assessment. When water is so clear that you can see through it, turbidity is close to zero. Turbidity is measured in Nephelometric Turbidity Units, or NTU.";
  var textYOffset = 35;
  var textXOffset = 50;
  ...
  function registerObservers() {
    d3.select("#branch").on("change.turbidity", updateBranch);
  }
  ...
  function showTooltip(d) {
    ...
    tooltip.select('[data-tooltip-role="title"]').text("Turbidity");
    tooltip.select('[data-tooltip-role="value"]').html(`${d.tooltipValue} NTU`);
    tooltip
