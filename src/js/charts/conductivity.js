var Conductivity = function (wrapper, i, branches, domain) {
  var debug = false;
  ...
  var fullText =
    "Specific Conductivity measures the ability of water to conduct electricity. Because this ability is directly proportional to the number of dissolved salt particles called ions, it is often used as a substitute for measuring salinity. Salinity is an important factor in the real-time water quality assessment. Specific conductivity is measured in microsiemens per centimeter, or uS/cm. The Specific conductivity of distilled water is close to zero.";
  var textYOffset = 35;
  var textXOffset = 50;
  ...
  function resetTitle() {
    ...
    title.push("Specific Conductivity");
    title.push("(μS/cm)");
  ...
  function registerObservers() {
    d3.select("#branch").on("change.conductivity", updateBranch);
  }
  ...
  function showTooltip(d) {
    ...
    tooltip.select('[data-tooltip-role="title"]').text("Specific Conductivity");
    tooltip
      .select('[data-tooltip-role="value"]')
      .html(`${d.tooltipValue} μS/cm`);
    tooltip
