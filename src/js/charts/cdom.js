var CDOM = function (wrapper, i, branches, domain) {
  var debug = false;
  ...
  var yScale = d3.scaleLinear().domain([0, 200]);
  ...
  var fullText =
    "Colored dissolved organic matter, or CDOM, is a signal that corresponds to fluorescent properties of natural organic matter, which is always present in surface waters. Some researchers believe that accounting for both TLF and CDOM will provide more accurate estimates of microbial concentrations. You may notice that the units on this plot are not the units of fluorescence - this is because the vendor who makes this CDOM sensor, Proteus Instruments, automatically converts fluorescence to estimated concentrations of natural organic matter in parts per billion, or ppb. CDOM data are not yet used in the real-time water quality assessment and we will evaluate CDOM’s influence on our modeling approach after the 2022 recreational season. For more detailed information, please see the FAQ page.";
  var textYOffset = 35;
  var textXOffset = 50;
  ...
  function registerObservers() {
    d3.select("#branch").on("change.cdom", updateBranch);
  }
  ...
  function showTooltip(d) {
    ...
    tooltip.select('[data-tooltip-role="title"]').text("CDOM");
